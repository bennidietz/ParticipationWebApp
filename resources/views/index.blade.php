<x-guest-layout>
        ...
        <div class="w-full h-full absolute top-0 left-0 bg-gray-800 bg-opacity-60 flex justify-center items-center">
            <div class="w-full p-8 flex justify-center items-left text-white" data-aos="zoom-in">
                <div class="w-full md:w-3/5 text-lg">
                    ...
                    <p class="mb-2 text-lg">{{ __('Der öffentliche Raum ist ein wichtiger Grundpfeiler für eine lebenswerte und klimagerechte Stadt Münster. Bisher sind Straßen vor allem Zufarts-, Verbindungswege und Orte der Mobilität. Sie können aber viel mehr sein.') }}</p>
                    ...
                    <p class="mb-2 text-lg">{{ __('Das CorrensLab findet unter Beachtung der aktuellen Coronaschutzverordnung statt. Wir schützen uns mit den AHA-Regeln sowie einem 3-G-Nachweis: Kommt getestet, genesen oder geimpft.') }}</p>
                    <div class="flex">
    ...
    <section class="py-24 max-w-7xl mx-auto">
        ...
        <p class="mb-2 text-lg">{{ __('Daran haben Studierende von FH und WWU in einem gemeinsamen Lehrprojekt auf Initative der Allianz für Wissenschaft Münster ein Semester experimentiert.') }}</p>
        ...
        <p class="mb-2 text-lg">{{ __('Um diese Fragen zu klären, wurde in Zusammenarbeit zwischen der Stadt Münster, Fachhochschule Münster und Uni Münster das Projekt CorrensLab ins Leben gerufen. Verschiedenste Akteur:innen machen sich bei diesem Projekt Gedanken, wie sich die Corrensstraße verändern könnte.') }}</p>
        ...
        <x-info-image-panel :image="asset('img/content/wem_gehoert_was.png')" title="Wem gehört Was?" text="Wem gehört eigentlich Was? Eine Frage, die bei der Stadtplanung nicht unwichtig ist. Denn wenn Veränderungen angestoßen werden, muss das mit den Eigentümer:innen abgesprochen und verhandelt werden. Genauere Angaben über die Besitzverhältnisse im Quartier finden Sie im Abschlussbericht 'Zukunft der Wissenschaftsstadt' auf Seite 9." url="https://www.muensterzukunft.de/_Resources/Persistent/e/4/7/f/e47f80f2566ae414e15fc582f5e9fb513ed53612/IIW_2020_Abschlussbericht.pdf"/>
        <x-info-image-panel image="https://www.muensterzukunft.de/_Resources/Persistent/e/f/1/8/ef187d2d1ea64706ecd05d594c6921dd1be769aa/UC_IIW_ScienceBoulevard.jpg" title="Die Corrensstraße als teil des Science Boulevards"  text="Münsters Westen soll neu vernetzt werden. Das bedeutet,bisher nicht sichtbare Zusammenhänge aufzuzeigen und für den Alltag neue Orte und Wege zu schaffen, die zum Austausch einladen und eine entspannte nachhaltige Mobilität ermöglichen.Die Wissenschaftsstadt Münster will einen Bogen schlagen von Kunst und Kreativität zu High Tech und Naturwissenschaften zu Medizin und Gesundheit. Das Projekt wird bereits verfolgt -für die nächsten 10 Jahre sind bereits bauliche Investitionsabsichten von wissenschaftlichen Einrichtungen in Höhe von rund 1,6 Mrd EUR in diesem Bereich bekannt – es werden perspektivisch eher mehr." url="https://www.muensterzukunft.de/aktuelles/science-boulevard.html"/>
