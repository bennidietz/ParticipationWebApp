<x-guest-layout>
    ...
    <section class="w-full min-h-screen bg-cover text-white flex items-stretch" style="background-image: url('{{ asset('img/about/Corrensstrasse_1.png') }}');">
        ...
        <div class="w-full p-8 bg-gray-900 bg-opacity-40 flex justify-center items-center">
            <div class="w-full p-8 flex justify-center items-left">
                <div class="w-full md:w-3/5 text-lg">
                    <h1 class="mb-4 text-2xl">{{ __('Die Corrensstraße im urbanem Wissensquartier') }}</h1>
                    ...
                    <p class="mb-4">{{ __('Sie wollen helfen den städtischen Raum zukunftssicher zu gestalten?   ') }}</p>
                    <p class="mb-4">{{ __(' Sie wollen der Corensstraße eine neue Aufenthaltsqualität zu geben?') }}</p>
                </div>
            </div>
    ...
    <section class="w-full min-h-screen bg-cover text-white flex items-stretch" style="background-image: url('{{ asset('img/about/Corrensstrasse_2.png') }}');">
        ...
        <div class="w-full p-8 bg-gray-900 bg-opacity-40 flex justify-center items-center">
            <div class="w-full p-8 flex justify-center items-left">
                <div class="w-full md:w-3/5 text-lg">
                    <h1 class="mb-4 text-2xl">{{ __('Machen Sie mit!') }}</h1>
                    ...
                    <button class="py-3 px-2 text-sm uppercase border rounded transition hover:bg-white hover:text-black">{{ __('Hier geht’s zum Projekt') }}</button>
               </div>
            </div>
        </div>
