<x-guest-layout>
    ...
    <section class="pl-5 pt-24 pb-8 max-w-7xl mx-auto">
        <h2 class="mb-4 text-3xl font-bold uppercase tracking-wider text-green-600">Sicherheit</h2>
        <div class="text-xl w-2/3 leading-relaxed tracking-wide">
            <br><h3 class='font-bold'>Auf der Straße der Zukunft sollst du als Verkehrsteilnehmer*in sicher von Punkt A nach Punkt B gelangen.</h3>
            <br>
            ...
            <br><br><h3 class='font-bold'>Geschwindigkeiten reduzieren</h3>
            ...
            <br><br><h3 class='font-bold'>Trennung der Straßennutzungen</h3>
            ...
            <br><br><h3 class='font-bold'>Shared Spaces</h3>
            ...
            <br><br><div class="italic">
                ...
                Allgemeiner deutscher Autoclub (2021): Bilanz Verkehrstote. Online unter: <a class="text-blue-800 hover:underline" href="https://www.adac.de/news/bilanz-verkehrstote/">https://www.adac.de/news/bilanz-verkehrstote/</a> (abgerufen 08.09.21)<br><br>
                Zukunft Mobilität (2015): Verkehrssicherheit. Todeswahrscheinlichkeit bei Verkehrsunfällen mit Fußgängerbeteiligung in Abhängigkeit der Fahrzeugge-schwindigkeit. Online unter:
                <a class="text-blue-800 hover:underline" href="https://www.zukunft-mobilitaet.net/156686/verkehrssicherheit/risiko-fussgaenger-kollission-fahrzeug-todesfall-geschwindigkeit-tempo30/">https://www.zukunft-mobilitaet.net/156686/verkehrssicherheit/risiko-fussgaenger-kollission-fahrzeug-todesfall-geschwindigkeit-tempo30/</a> (abgerufen 08.09.21)<br><br>
                Radentscheid Frankfurt (2019): Online unter: <a class="text-blue-800 hover:underline" href="https://www.radentscheid-frankfurt.de/2019/07/bauliche-trennung-warum-farbe-keine-infrastruktur-ist/">https://www.radentscheid-frankfurt.de/2019/07/bauliche-trennung-warum-farbe-keine-infrastruktur-ist/</a> (ab-gerufen 08.09.21)<br><br>
                Nullbariere (o. J.): Shared Space. Gemeinsam genutzter Verkehrsraum. Online unter: <a class="text-blue-800 hover:underline" href="https://nullbarriere.de/shared-space.htm">https://nullbarriere.de/shared-space.htm</a> (abgerufen 08.09.21)
            </div>
        </div>
    </section>
</x-guest-layout>
