    ...
    <section class="pl-5 pt-24 max-w-7xl mx-auto">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3">
            ...
            <a href="{{ route('mobility.barrierefreiheit') }}">
                <x-text-card-view text="Barrierefreiheit" imageUrl="<?php echo e(asset('img/content/mobility/')); ?>"></x-text-card-view>
            </a>
            <a href="{{ route('mobility.sicherheit') }}">
                <x-text-card-view text="Sicherheit" imageUrl="<?php echo e(asset('img/content/mobility/')); ?>"></x-text-card-view>
            </a>
