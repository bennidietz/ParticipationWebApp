...
//            ->create();
        Polygon::create([
            ...
            'state' => 'unknown',
            'visible' => 1,
            'description' => 'Das Mensa am Ring-Polygon erstreckt sich von der Einsteinstraße bis hin zur Wilhelm-Klemm-Straße.',
        ]);
        Polygon::create([
            'name' => 'Polygon an der Grünfläche',
            ...
            'state' => 'unknown',
            'visible' => 1,
            'description' => 'Das Polygon an der Grünfläche erstreckt sich von der Wilhelm-Klemm-Straße bis hin zur Röntgenstraße.',
        ]);
        Polygon::create([
            'name' => 'Polygon Fachhochschule',
            ...
            'state' => 'unknown',
            'visible' => 1,
            'description' =>  'Das Polygon Fachhochschule erstreckt sich von der Röntgenstraße bis hin zur Heisenbergstraße.',
        ]);
        Polygon::create([
            'name' => 'Polygon am Geoinstitut',
            ...
            'state' => 'unknown',
            'visible' => 1,
            'description' =>  'Das Polygon am Geoinstitut erstreckt sich von der Heisenbergstraße bis hin zur Mendelstraße.',
        ]);
        Polygon::create([
            'name' => 'Polygon am Studiwohnheim',
            ...
            'state' => 'unknown',
            'visible' => 1,
            'description' =>  'Das Polygon am Studiwohnheim erstreckt sich von der Mendelstraße bis hin zum Horstmarer Landweg.',
        ]);
    }
}
